...
public class titanLanderDUO {

    static double thrust = 0;
    static double leftThrust;
    static double rightThrust;
    ...
    private final static double INITIAL_HEIGHT = 4000;        //Starting height in meters
    private final static double INITIAL_VELOCITY = 9.6;    //Starting descent rate (m/sec)
    private final static double INITIAL_FUEL = 1200.0;        //Starting fuel in kg
    ...
    public static double time_to_touchdown = 0;    //secs from now to touchdown
    private double time_to_fuel_out = 0;
    public static double airTime = 736; //secs from a previous test
    ...
    static double height = INITIAL_HEIGHT;
    static double velocity = INITIAL_VELOCITY;
    static double fuel = INITIAL_FUEL;
    static double t = 0;//secs from now to fuel gone
    static double x = 2;
    private double oldH;
 ...
 void feedback() {
     ...
     while (!touchdown) {
         ...
         boolean heighttouch = height <2.5;


         touchdown = fuel_out || time_to_touchdown < TIME_SLICE || heighttouch  ;
